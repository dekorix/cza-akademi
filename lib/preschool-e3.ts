...
const receptiveLanguageTasks = sectionTasks('receptive_language', [
  ...
  { title: 'Konum Sözcüğü', childInstruction: 'Arabayı kutunun içine koy.', educatorInstruction: 'İçine/üstüne/altına gibi konum sözcüğünü nesneyle uygulat.', responseMode: 'MANIPULATIVE', materials: ['oyuncak araba', 'kutu'], evidenceFocus: ['konum dili'] },
  { title: 'Niteliğe Göre Seç', childInstruction: 'Uzun kalemi bana ver.', educatorInstruction: 'Aynı tür iki nesne arasında nitelik sözcüğünü kullan.', responseMode: 'MANIPULATIVE', materials: ['uzun kalem', 'kısa kalem'], evidenceFocus: ['nitelik anlama'] },
  { title: 'Kim-Ne Yapıyor?', childInstruction: 'Resimde kim koşuyor?', educatorInstruction: 'Eylem ve özneyi ayırt etmesini gözle.', responseMode: 'SPEAK', evidenceFocus: ['eylem anlama', 'soru anlama'] },
  { title: 'İki Aşamalı Yönerge', childInstruction: 'Önce küpü kutuya koy, sonra bana kaşığı ver.', educatorInstruction: 'Yönergeyi tekrar etmeden ilk performansı kaydet.', responseMode: 'MANIPULATIVE', materials: ['küp', 'kutu', 'kaşık'], evidenceFocus: ['iki aşama', 'işitsel çalışma belleği'] },
  { title: 'Önce-Sonra', childInstruction: 'Önce ellerini çırp, sonra masaya dokun.', educatorInstruction: 'Sıra sözcüklerini ve eylem sırasını değerlendir.', responseMode: 'OBSERVE', evidenceFocus: ['sıralı yönerge'] },
  { title: 'Üç Özellikli Yönerge', childInstruction: 'Küçük kırmızı topu kutunun üstüne koy.', educatorInstruction: '45+ ay tavan kanıtıdır; başarısızlık gelişim geriliği olarak yorumlanmaz.', responseMode: 'MANIPULATIVE', materials: ['küçük kırmızı top', 'büyük kırmızı top', 'küçük mavi top', 'kutu'], evidenceFocus: ['çoklu sözel özellik'] },
]);
