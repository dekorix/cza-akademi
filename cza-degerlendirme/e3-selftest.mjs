...
for(const file of ['e3-bank-v3.js','e3-engine-v3.js']){
...
assert.equal(bank.allTasks.length,120,'Toplam görev bankası 120 görev olmalı');
...
for(const d of bank.domains){
  assert.equal(d.tasks.length,12,`${d.id} alanında 12 görev olmalı`);
...
console.log('E3_V3_SELFTEST_OK',JSON.stringify({domains:bank.domains.length,tasks:bank.allTasks.length,caregiver:bank.caregiver.length}));
