...
test('invalid input is rejected',()=>{for(const values of [{digits:0},{digits:4},{terms:11},{rounds:0},{interval:.1},{interval:NaN},{pool:[]},{pool:[0]},{mode:'unknown'},{operation:'bad'}])assert.throws(()=>validateConfig({...defaultConfig,...values}));});
