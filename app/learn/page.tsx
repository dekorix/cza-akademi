...
export default function Learn() {
  ...
  return <div className="min-h-screen bg-background">
    <header className="bg-[#182739] px-5 text-white md:px-9"><div className="mx-auto flex min-h-20 max-w-[1400px] flex-wrap items-center justify-between gap-3 py-4"><a href="/" className="flex items-center gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#d8eeac] text-xs font-black text-[#182739]">CZA</span><div><p className="text-sm font-semibold">Soroban öğrenme yolu</p><p className="mt-0.5 text-[10px] tracking-widest text-[#aebdcd]">EGZERSİZ AKADEMİSİ</p></div></a><a href="/" className="flex items-center gap-2 text-xs text-[#cfdfec]"><ArrowLeft size={15}/> Çalışma merkezim</a></div></header>
